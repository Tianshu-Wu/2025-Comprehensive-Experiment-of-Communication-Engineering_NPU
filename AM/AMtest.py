...
class AMtest(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "AMtest")
        ...
        self._noise_range = qtgui.Range(0, 1, 10e-3, 50e-3, 200)
        ...
        self.channels_channel_model_0 = channels.channel_model(
            ...
            noise_seed=0,
            block_tags=False)
        self.blocks_wavfile_source_0 = blocks.wavfile_source('E:\\Communication_Experiment\\test audio.wav', True)
        ...
        self.connect((self.blocks_multiply_xx_1, 0), (self.qtgui_freq_sink_x_0_0_1, 0))
        self.connect((self.blocks_multiply_xx_1, 0), (self.qtgui_time_sink_x_0_1, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 50000, 2000, window.WIN_HAMMING, 6.76))
...
def main(top_block_cls=AMtest, options=None):
