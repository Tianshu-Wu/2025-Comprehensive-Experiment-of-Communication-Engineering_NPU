...
class default(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._noise_range = qtgui.Range(0, 1, 10e-3, 10e-3, 200)
        ...
        self.connect((self.blocks_wavfile_source_0, 0), (self.qtgui_freq_sink_x_0_0_1_0, 0))
    ...
    def set_audio_samp_rate(self, audio_samp_rate):
        ...
        self.qtgui_freq_sink_x_0_0_1_0.set_frequency_range(0, self.audio_samp_rate)
